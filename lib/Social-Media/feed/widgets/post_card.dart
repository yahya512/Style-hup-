      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                IconButton(icon: const Icon(Icons.favorite_border), iconSize: 26.r, color: Colors.black87, onPressed: () {}),
                Text('${post.reactionsCount}', style: AppStyles.labelTextStyle),
                SizedBox(width: 4.w),
                IconButton(icon: const Icon(Icons.chat_bubble_outline), iconSize: 24.r, color: Colors.black87, onPressed: () {}),
                Text('${post.commentsCount}', style: AppStyles.labelTextStyle),
                const Spacer(),
                IconButton(icon: const Icon(Icons.bookmark_border), iconSize: 24.r, color: Colors.black87, onPressed: () {}),
              ],
            ),
          ),
